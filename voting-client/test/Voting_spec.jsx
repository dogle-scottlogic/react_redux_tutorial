...
describe('Voting', () => {
    ...
    it('renders as a pure componet', () => {
        const pair = ['Trainspotting', '28 Days Later'];
        const container = document.createElement('div');
        let componet = ReactDOM.render(
            <Voting pair={pair}/>, container);
        let firstButton = scryRenderedDOMComponentsWithTag(componet, 'button')[0];
        expect(firstButton.textContent).to.equal('Trainspotting');

        pair[0] = 'Sunshine';
        componet = ReactDOM.render(
            <Voting pair={pair}/>, container);
        firstButton - scryRenderedDOMComponentsWithTag(componet, 'button')[0];
        expect(firstButton.textContent).to.equal('Trainspotting');
    });
